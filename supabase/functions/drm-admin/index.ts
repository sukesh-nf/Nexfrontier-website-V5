  ...
  try {
    ...
    if (action === 'invite-admin') {
      ...
      const emailHtml = emailTemplate({
        ...
        bodyHtml: `
          ...
          <p style="color:#94a3b8;font-size:14px;line-height:1.7;margin:0 0 20px">
            You've been invited as a ${role.replace('_', ' ')} for the NexFrontier Investor Data Room. Click below to set your passphrase and activate your account.
          </p>
      ...
      const emailResult = await sendMailgunEmail({
        to: email,
        subject: 'You\u2019ve been invited to NexFrontier\u2019s Investor Data Room admin',
        html: emailHtml,
      });
